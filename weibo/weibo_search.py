...
post_string = '''</p></div><div style="grid-column-start: 1;grid-column-end: 3;padding-left: 10px;">'''

# {content}

comment_string = '''</div></div></a><div style="padding:10pt 10pt 10pt;color: slategray;font-size: small;">'''

div_end_string = '''</div></div>'''

end_string = '''</body></html>'''

source_end_string = '''</div></div></a></div>'''
