...
class WeiBoAnalyse(object):
    ...
    async def get_date_users(self):
        ...
        day_list = [str(i) for i in range(20210610, 20210611)]
        for date in day_list:
            ...
            for user in users:
                ...
                sourceid = "5690879901" # str(source["user"]["id"])
                name = "只是凡fan" #source["user"]["screen_name"]
            ...
            print("%s 主动关注率 %s" % (date, fans_percent))
